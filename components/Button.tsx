...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#18181b]";
  
  const variants = {
    primary: "bg-yellow-500 hover:bg-yellow-400 text-black shadow-lg shadow-yellow-500/20 focus:ring-yellow-500",
